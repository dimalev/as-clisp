package com.clisp.api {
  ...
  public class Strings {
    [Macros(name="concat")]
    public function concat(se:ScriptEngine, ctx:ScriptContext, scope:uint, args:CLispCons):CLispSymbol {
    ...
    [Macros(name="strlen")]
    public function strlen(se:ScriptEngine, ctx:ScriptContext, scope:uint, args:CLispCons):CLispSymbol {
      var arg:CLispSymbol = se.execute(ctx, args.car, scope);
    ...
    [Macros(name="substr")]
    public function substr(se:ScriptEngine, ctx:ScriptContext, scope:uint, args:CLispCons):CLispSymbol {
